...
loop do
    ...
    if(calMulta > 0 && calMulta <= 10)
        puts "O motorista estava na velocidade #{velMoto} Km/h em uma velocidade permitida na Avenida #{velPermitida} km/h.
        Tendo uma diferença de #{calMulta} Km/h. Tera que paga uma muta de R$ 50,00"
    elsif (calMulta >= 11 && calMulta <= 30)
        puts "O motorista estava na velocidade #{velMoto} Km/h em uma velocidade permitida na Avenida #{velPermitida} km/h
        Tendo uma diferença de #{calMulta} Km/h. Tera que paga uma muta de R$ 100,00"
    elsif (calMulta >= 31)
        puts "O motorista estava na velocidade #{velMoto} Km/h em uma velocidade permitida na Avenida #{velPermitida} km/h
        Tendo uma diferença de #{calMulta} Km/h. Tera que paga uma muta de R$ 200,00"
    else 
